...
license: MIT
tags: [cv, academic, career, research]
testingTypes: [career]
frameworks: []
languages: [markdown]
domains: [web]
...
Software testing has a real academic track (ICST, ISSTA, fuzzing and verification research, testing-education roles) and it wants a CV, not a resume: complete publication list, grants, teaching, service. If you are industry-side QA moving toward research or teaching, lead with anything peer-reviewed or published (conference talks, tool papers, well-cited blog work counts in adjacent hiring), then map industry work to research vocabulary: your flaky-test program is empirical software engineering; your fuzzing harness is automated test generation.
