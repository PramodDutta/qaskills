...
export const FALLBACK_SKILLS: SkillSummary[] = [
  ...
  },
  {
    ...
    slug: 'vibe-check',
    description:
      'AI-native browser automation with CLI commands for navigation, forms, screenshots, tabs, and related QA workflows.',
    author: 'vibiumdev',
    qualityScore: 95,
    installCount: 75,
  ...
  },
  {
    ...
    featured: true,
    verified: true,
    createdAt: PLAYWRIGHT_CLI_LAUNCH_DATE,
  },
  {
    id: '3',
  ...
  },
  {
    ...
    description: 'Test data strategies using Faker.js, factories, builders, and database seeding',
    author: 'thetestingacademy',
    qualityScore: 83,
    installCount: 18,
  ...
  },
  {
    ...
    slug: 'jest-unit',
    description: 'Jest unit testing patterns with mocking, spies, snapshots, and async testing',
    author: 'thetestingacademy',
    qualityScore: 91,
    installCount: 64,
    testingTypes: ['unit'],
  ...
  },
  {
    ...
    description: 'Visual regression testing with Playwright screenshots and diff comparison',
    author: 'thetestingacademy',
    qualityScore: 86,
    installCount: 16,
  ...
  },
  {
    ...
    description: 'Consumer-driven contract testing with Pact and Pact Broker',
    author: 'thetestingacademy',
    qualityScore: 84,
    installCount: 7,
