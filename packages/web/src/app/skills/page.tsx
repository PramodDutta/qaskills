...
export const metadata = {
  title: 'Browse 450+ QA Skills for AI Agents',
  description:
...
async function getSkills(searchParams: Awaited<SkillsPageProps['searchParams']>): Promise<SkillsResult> {
  ...
  try {
    ...
    const fallback = FALLBACK_SKILLS;
    ...
    filtered = sortFallbackSkills(filtered, sort as any);
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'Search and filter curated QA testing skills for AI coding agents. Playwright, Cypress, Jest, and 450+ skills.',
            url: 'https://qaskills.sh/skills',
            mainEntity: {
              '@type': 'ItemList',
