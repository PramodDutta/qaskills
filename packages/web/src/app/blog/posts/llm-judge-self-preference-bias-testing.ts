...
This guide treats the judge like any other probabilistic component under test. We will construct a crossed generator-by-judge experiment, blind provenance, swap response positions, use verifiable items where possible, retain repeated judgments, and calculate effects that engineering teams can monitor over time. For the broader discipline around score stability and reference sets, read the [LLM judge calibration guide](/blog/llm-judge-calibration-guide-2026). For choosing rubrics and judge modes before investigating a specific bias, use the [LLM-as-a-judge evaluation guide](/blog/llm-as-a-judge-evaluation-guide-2026).
