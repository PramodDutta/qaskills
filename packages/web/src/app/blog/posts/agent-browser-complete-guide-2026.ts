...
Explore how it fits a broader agent strategy in our [agentic testing complete guide](/blog/agentic-testing-complete-guide), compare it with the Playwright approach in our [Playwright MCP server configuration guide](/blog/playwright-mcp-server-configuration-2026), and visit the [MCP testing skills hub](/skills-for/mcp-testing) for related tooling. Browse the full [QA skills directory](/skills) to install browser-automation skills into your agent, or [compare automation tools](/compare) to choose the right fit for your team.
`,
};
