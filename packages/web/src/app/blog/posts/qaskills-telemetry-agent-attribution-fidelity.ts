...
export const post = createArticleFactory1000Post({
  ...
  title: 'Qaskills Telemetry Agent Attribution Fidelity',
  description:
    'QASkills telemetry agent attribution fidelity: test the contract with controlled fixtures, exact assertions, clear failure diagnostics, safe evidence.',
  primaryKeyword: 'QASkills telemetry agent attribution fidelity',
  intent: 'troubleshooting',
  coreQuestion:
    'How should QA teams diagnose QASkills telemetry agent attribution fidelity, including multi-agent arrays reduced to one stored agentType?',
  intentBoundary:
    'Covers multi-agent arrays reduced to one stored agentType. Excludes agent selection itself.',
  secondaryKeywords: [
    'how to test telemetry agent attribution fidelity',
    'telemetry agent attribution fidelity test cases',
    'telemetry agent attribution fidelity edge cases',
    'telemetry agent attribution fidelity CI validation',
    'telemetry agent attribution fidelity failure diagnostics',
    'telemetry agent attribution fidelity regression coverage',
  ],
  repoEvidence: [
  ...
  codeExamples: [
    {
      title: 'Build the QASkills telemetry agent attribution fidelity baseline',
      language: 'typescript',
