...
export const post = createArticleFactory1000Post({
  ...
  title: 'Qaskills Symbolic Link Copy Fidelity',
  description:
    'QASkills symbolic link copy fidelity: test the contract with controlled fixtures, exact assertions, clear failure diagnostics, safe evidence, verified.',
  primaryKeyword: 'QASkills symbolic link copy fidelity',
  intent: 'troubleshooting',
  coreQuestion:
    'How should QA teams diagnose QASkills symbolic link copy fidelity, including symbolic links encountered by recursive copyDir?',
  intentBoundary:
    'Covers symbolic links encountered by recursive copyDir. Excludes agents declared with symlink installMethod.',
  secondaryKeywords: [
    'how to test symbolic link copy fidelity',
    'symbolic link copy fidelity test cases',
    'symbolic link copy fidelity edge cases',
    'symbolic link copy fidelity CI validation',
    'symbolic link copy fidelity failure diagnostics',
    'symbolic link copy fidelity regression coverage',
  ],
  repoEvidence: [
  ...
  codeExamples: [
    {
      title: 'Build the QASkills symbolic link copy fidelity baseline',
      language: 'typescript',
