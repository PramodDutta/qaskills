...
export const post = createArticleFactory1000Post({
  ...
  title: 'Qaskills Staging Directory Leak Testing',
  description:
    'QASkills staging directory leak testing: test the contract with controlled fixtures, exact assertions, clear failure diagnostics, safe evidence, verified.',
  primaryKeyword: 'QASkills staging directory leak testing',
  intent: 'troubleshooting',
  coreQuestion:
    'How should QA teams diagnose QASkills staging directory leak testing, including cleanup after copy or removal failures in extraction staging?',
  intentBoundary:
    'Covers cleanup after copy or removal failures in extraction staging. Excludes normal completed extraction.',
  secondaryKeywords: [
    'how to test staging directory leak',
    'staging directory leak test cases',
    'staging directory leak edge cases',
    'staging directory leak CI validation',
    'staging directory leak failure diagnostics',
    'staging directory leak regression coverage',
  ],
  repoEvidence: [
  ...
  codeExamples: [
    {
      title: 'Build the QASkills staging directory leak testing baseline',
      language: 'typescript',
